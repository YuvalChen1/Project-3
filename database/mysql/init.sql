...
CREATE TABLE `followers` (
  ...
  CONSTRAINT `vacationKey` FOREIGN KEY (`vacationId`) REFERENCES `vacations_table` (`id`) ON DELETE CASCADE
...
INSERT INTO `users` VALUES (1, 'init', 'user', 'user@example.com', 'user', 'user', 'salt');
INSERT INTO `users` VALUES (2, 'init', 'admin', 'admin@example.com', 'admin', 'admin', 'salt');
